...
import subprocess
import sys
from session_utils import get_current_user, set_current_user

ctk.set_appearance_mode("dark")
ctk.set_default_color_theme("blue")


class CustomerSecurityUI(ctk.CTk):
    def __init__(self):
        super().__init__()
    ...
    def save_changes(self):
        ...
        conn = sqlite3.connect(os.path.join(self.base_path, "app_data.db"))
        cursor = conn.cursor()
