...
class FirstAidUI(ctk.CTk):
    def __init__(self):
        super().__init__()

        self.title("Manage First Aid Items")
    ...
    def load_first_aid_items(self):
        placeholders = ",".join("?" for _ in FIRST_AID_ITEMS)
        self.cursor.execute(
            f"""
    ...
    def create_row(self, data, index):
        ...
        img_path = "assets/images/firstaid.png"
